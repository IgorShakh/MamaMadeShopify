...
(function () {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    window.formatMoney = Currency.formatMoney;
    /***/
  },
  /* 5 */
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_2__Currency__ = __webpack_require__(4);
    /* harmony reexport (binding) */
    ...
    var Popover = function () {
      ...
      _createClass(Popover, [{
        ...
        value: function _valueChanged(event) {
          ...
          console.log('Update the cost per meal');
          var mealPrice = $('.ProductForm__Option select').find(":selected").data('mealCost');
          var discountMessage = $('.ProductForm__Option select').find(":selected").data('discountMessage');
          // console.log(mealPrice);
          // console.log(discountMessage);
          $('[js-meal-cost]').html(mealPrice);
          $('[js-discount-message]').html(discountMessage);
        }
        /**
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_2__helper_Form__ = __webpack_require__(20);
    /* harmony import */
    ...
    var __WEBPACK_IMPORTED_MODULE_4__helper_Currency__ = __webpack_require__(4);
    /**
    ...
    var ProductVariants = function () {
      ...
      _createClass(ProductVariants, [{
        ...
        value: function _onVariantChanged(previousVariant, newVariant) {
          ...
          this._updateSku(newVariant, previousVariant); // 4th: the add to cart button
        ...
        value: function _updateAddToCartButton(newVariant) {
          ...
          if (!newVariant) {
            ...
            if (newVariant['available']) {
              ...
              newButton.classList.add(this.options['showPaymentButton'] ? 'Button--secondary' : 'Button--secondary');
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_1__helper_Currency__ = __webpack_require__(4);
    /* harmony import */
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_1__Collapsible__ = __webpack_require__(21);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_3__LoadingBar__ = __webpack_require__(22);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_4__Modal__ = __webpack_require__(23);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_6__PageTransition__ = __webpack_require__(24);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_7__ProductItemColorSwatch__ = __webpack_require__(5);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_12__SearchBar__ = __webpack_require__(25);
    /* harmony reexport (binding) */
          ...
          if (window.theme.showPageTransition && this.pageTransition) {
            var doTransition = function doTransition(event) {
              ...
              if (event.propertyName === 'opacity') {
                _this17.pageTransition.removeEventListener('transitionend', doTransition);
      ...
      _createClass(SearchBar, [{
        ...
        value: function _openSearch() {
          ...
          var onFocusListener = function onFocusListener() {
            _this18.searchInputElement.focus();

            _this18.searchElement.removeEventListener('transitionend', onFocusListener);
          };
        ...
        value: function _closeSearch() {
          ...
          var onTransitionEnd = function onTransitionEnd(event) {
            if (event.propertyName === 'visibility') {
              ...
              _this19.pageOverlayElement.removeEventListener('transitionend', onTransitionEnd);
            }
          };
        ...
        value: function _onInput(event) {
          ...
          if (window.theme.searchMode !== 'product') {
            queries.push(fetch(window.theme.localeRootUrl + '/search?view=ajax&q=' + encodeURIComponent(this.lastInputValue) + '*&type=' + window.theme.searchMode.replace('product,', '').replace('page', ''), queryOptions));
          }
          ...
          Promise.all(queries).then(function (responses) {
            ...
            if (_this20.lastInputValue !== event.target.value) {
              return;
            }

            delete _this20.queryMap[event.target.value];
            ...
            Promise.all(responses.map(function (response) {
              ...
              if (window.theme.searchMode === 'product') {
                _this20.searchResultsElement.innerHTML = contents[0];
              } else {
                _this20.searchResultsElement.innerHTML = '<div class="PageLayout PageLayout--breakLap">\n              <div class="PageLayout__Section">' + contents[0] + '</div>\n              <div class="PageLayout__Section PageLayout__Section--secondary">' + contents[1] + '</div>\n            </div>';
              }

              _this20.searchResultsElement.setAttribute('aria-hidden', 'false');
              // _this20.searchResultsElement.style.display = 'block';
            });
            document.dispatchEvent(new CustomEvent('theme:loading:end'));
          });
        }
        ...
        value: function _resetSearch() {
          ...
          // _this20.searchResultsElement.style.display = 'none';
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var AddressesSection = function AddressesSection() {
      ...
      __WEBPACK_IMPORTED_MODULE_0__helper__["DomHelper"].nodeListToArray(document.querySelectorAll('.Modal--address')).forEach(function (modal) {
        _this22.countrySelectors.push(new __WEBPACK_IMPORTED_MODULE_1__components_CountrySelector__["default"](modal.querySelector('[name="address[country]"]'), modal.querySelector('[name="address[province]"]')));
      });
    };
    /* harmony export (immutable) */
        ...
        value: function _reveal(results) {
          ...
          results.forEach(function (result) {
            if (result.isIntersecting || result.intersectionRatio > 0) {
              ...
              _this24.intersectionObserver.unobserve(result.target);
            }
          });
      ...
      _createClass(ArticleSection, [{
        ...
        value: function _checkToolbarVisibility() {
          ...
          fastdom.measure(function () {
            ...
            if (_this26.articleNavElement) {
              navBottom = _this26.articleNavElement.offsetTop + _this26.articleNavElement.clientHeight - headerHeight;
            }
          });
          fastdom.mutate(function () {
            // _this26.toolbarElement.style.top = isFixedHeader ? headerHeight + 'px' : null;

            // if (_this26.articleNavElement) {
            //   if (lastYPosition > 150 && _this26.articleNavElement && lastYPosition < navBottom) {
            //     _this26.toolbarElement.classList.add('is-visible');
            //   } else {
            //     _this26.toolbarElement.classList.remove('is-visible');
            //   }
            // } else {
        ...
        value: function _reveal(results) {
          ...
          results.forEach(function (result) {
            if (result.isIntersecting || result.intersectionRatio > 0) {
              ...
              _this27.intersectionObserver.unobserve(result.target);
            }
          });
      ...
      _createClass(BackgroundVideoSection, [{
        ...
        value: function _loadScript() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            script.async = true;
            script.src = _this28.options['videoType'] === 'youtube' ? '//www.youtube.com/iframe_api' : '//player.vimeo.com/api/player.js';
          });
        }
      }, {
        key: 'onUnload',
        ...
        value: function _setupPlayer() {
          ...
          var playerLoadingInterval = setInterval(function () {
            if (_this29.options['videoType'] === 'youtube') {
              if (window.YT) {
                _this29.player = new YT.Player(elementToInsert, {
                  videoId: _this29.options['videoId'],
                  playerVars: {
                    showinfo: 0,
                    controls: 0,
                    fs: 0,
                    ...
                    modestbranding: 1,
                    disablekb: 1,
                    origin: _this29.options['requestHost']
                  },
                  events: {
                    onReady: _this29._onYouTubeReady.bind(_this29),
                    onStateChange: _this29._onYouTubeStateChange.bind(_this29)
                  }
                });
              ...
              if (window.Vimeo) {
                _this29.player = new Vimeo.Player(elementToInsert.parentNode, {
                  id: _this29.options['videoId'],
                  autoplay: true,
                  muted: true,
                  background: true,
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_2__helper_Currency__ = __webpack_require__(4);
    /* harmony import */
    ...
    var CartSection = function () {
      ...
      _createClass(CartSection, [{
        ...
        value: function _toggleCartNote() {
          ...
          if (this.element.classList.contains('has-note-open')) {
            var transitionEndListener = function transitionEndListener() {
              _this30.element.querySelector('#cart-note').focus();
        ...
        value: function _updateItemQuantity(event, target) {
          ...
          fetch(window.theme.localeRootUrl + '/cart/change.js', {
            ...
            cart.json().then(function (content) {
              _this31.itemCount = content['item_count'];

              _this31._rerenderCart(elementToAnimate);
        ...
        value: function _rerenderCart(elementToAnimate) {
          var _this33 = this; // if (_this33.options['drawer'] && elementToAnimate) {
          //   var timelineLite = new TimelineLite({ onComplete: function onComplete() {
          //     window.buildCart();
          //   }});
          //   timelineLite.to(elementToAnimate, 0.5, { height: 0, opacity: 0, ease: Cubic.easeOut }, 0);
          //   if (_this33.itemCount === 0) {
          //     timelineLite.to(_this33.element.querySelector('.Drawer__Footer'), 0.5, { y: '100%', transition: 'none', ease: Cubic.easeInOut }, 0);
          //   }
          // } else {
          //   window.buildCart();
          // }
          ...
          return fetch(window.theme.localeRootUrl + '/cart?view=' + (this.options['drawer'] ? 'drawer' : 'ajax') + '&timestamp=' + Date.now(), {
            ...
            if (_this33.options['drawer'] && elementToAnimate) {
              var timelineLite = new TimelineLite({
                onComplete: function onComplete() {
                  content.text().then(function (html) {
                    _this33._replaceContent(html);
                  });
                }
              });
              ...
              if (_this33.itemCount === 0) {
                timelineLite.to(_this33.element.querySelector('.Drawer__Footer'), 0.5, {
                  y: '100%',
                  transition: 'none',
        ...
        value: function _replaceContent(html) {
          ...
          if (!this.element.querySelector('.Cart')) return;
          var cartNodeParent = this.element.querySelector('.Cart').parentNode;

          if (this.options['drawer'] && this.element.querySelector('.Drawer__Main')) {
            var currentScrollPosition = this.element.querySelector('.Drawer__Main').scrollTop;
            cartNodeParent.replaceChild(tempElement.querySelector('.Cart'), this.element.querySelector('.Cart'));
            this.element.querySelector('.Drawer__Main').scrollTop = currentScrollPosition;
          } // Declared in theme.liquid first


          window.buildCart(); // Globally exposed function within cart.js module to render the grouped items.
          ...
          cartQuantity.forEach(function (item) {
            item.textContent = _this34.itemCount;
          });
        }
      }]);
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_2__components_ProductItemColorSwatch__ = __webpack_require__(5);
    /* harmony import */
    ...
    var __WEBPACK_IMPORTED_MODULE_6__helper_Currency__ = __webpack_require__(4);
      ...
      _createClass(CollectionSection, [{
        ...
        value: function _setupAnimation() {
          ...
          __WEBPACK_IMPORTED_MODULE_3__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.ProductList .ProductItem')).forEach(function (item) {
            _this35.intersectionObserver.observe(item);
          });
        }
      }, {
        key: '_reveal',
        value: function _reveal(results) {
          ...
          results.forEach(function (result) {
            if (result.isIntersecting || result.intersectionRatio > 0) {
              ...
              _this36.intersectionObserver.unobserve(result.target);
            }
          });
          ...
          if (productList) {
            ...
            __WEBPACK_IMPORTED_MODULE_3__helper_Dom__["default"].nodeListToArray(productList.querySelectorAll('.Grid__Cell')).forEach(function (item) {
              if (layoutType === 'mobile') {
                ...
                if (_this37.settings['filterPosition'] === 'drawer') {
        ...
        value: function _updateActiveTags() {
          ...
          __WEBPACK_IMPORTED_MODULE_3__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.CollectionFilters [data-tag]')).forEach(function (item) {
            ...
            if (_this38.temporaryTags.includes(item.getAttribute('data-tag'))) {
        ...
        value: function _commit() {
          ...
          __WEBPACK_IMPORTED_MODULE_3__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('[data-action="reset-tags"]')).forEach(function (resetButton) {
            resetButton.style.display = _this39.currentTags.length === 0 ? 'none' : 'block';
          });
        }
      }, {
        key: '_reloadProducts',
        value: function _reloadProducts() {
          ...
          fetch(location.pathname + '?view=ajax&sort_by=' + this.currentSortBy, {
            ...
            response.text().then(function (content) {
              ...
              _this40.collectionInnerElement.innerHTML = tempElement.querySelector('.shopify-section').innerHTML;
              document.dispatchEvent(new CustomEvent('theme:loading:end')); // Convert any amount (if applicable)

              if (window.theme.currencyConversionEnabled) {
                __WEBPACK_IMPORTED_MODULE_6__helper_Currency__["default"].convertAll(_this40.element);
              }

              _this40._setupAnimation(); // We scroll to the top


              var elementOffset = _this40.element.querySelector('.CollectionMain').getBoundingClientRect().top - parseInt(document.documentElement.style.getPropertyValue('--header-height'));

              if (__WEBPACK_IMPORTED_MODULE_4__helper_Responsive__["default"].matchesBreakpoint('lap-and-up') && _this40.toolbarElement && _this40.toolbarElement.clientHeight === 0) {
                elementOffset -= 50;
              }
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_1__components_ProductItemColorSwatch__ = __webpack_require__(5);
    /* harmony import */
    ...
    var FeaturedCollectionsSection = function () {
      function FeaturedCollectionsSection(container) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('[data-flickity-config]')).forEach(function (item) {
          _this41.carousels.push(new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](item));
        }); // Setup product item color swatch
      ...
      _createClass(FeaturedCollectionsSection, [{
        ...
        value: function _switchTab(event, target) {
          var _this42 = this; // If the tab is already active, do nothing
          ...
          this.timeline.eventCallback('onReverseComplete', function () {
            ...
            if (__WEBPACK_IMPORTED_MODULE_3__helper__["ResponsiveHelper"].matchesBreakpoint('lap-and-up')) {
              _this42.carousels.forEach(function (carousel) {
            ...
            _this42.timeline.clear();

            _this42._setupAnimation();
          });
        ...
        value: function _setupAnimation() {
          ...
          if (this.options['layout'] === 'grid' && window.theme.showElementStaggering) {
            ...
            __WEBPACK_IMPORTED_MODULE_2__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.TabPanel[aria-hidden="false"] .ProductList .ProductItem')).forEach(function (item) {
              _this43.intersectionObserver.observe(item);
            });
          } else {
        ...
        value: function _reveal(results) {
          ...
          results.forEach(function (result) {
            if (result.isIntersecting || result.intersectionRatio > 0) {
              ...
              _this44.intersectionObserver.unobserve(result.target);
            }
          });
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_2__components__ = __webpack_require__(19);
      ...
      function HeaderSection(container) {
        ...
        if (mainLogo && !mainLogo.complete) {
          mainLogo.addEventListener('load', function () {
            fastdom.measure(function () {
              document.documentElement.style.setProperty('--header-height', _this45.element.clientHeight + 'px');
              document.documentElement.style.setProperty('--header-is-not-transparent', _this45.options['hasTransparentHeader'] ? 0 : 1);
            });
          });
        } else {
          fastdom.measure(function () {
      ...
      _createClass(HeaderSection, [{
        ...
        value: function onBlockSelect(event) {
          ...
          fastdom.mutate(function () {
            ...
            _this46.element.classList.remove('Header--transparent'); // This is needed to make sure everything is visible
        ...
        value: function _focusNavigation() {
          ...
          fastdom.mutate(function () {
            if (!_this47.isTouch || __WEBPACK_IMPORTED_MODULE_1__helper_Responsive__["default"].matchesBreakpoint('desk')) {
              _this47.element.classList.remove('Header--transparent');
            }
          });
        }
      }, {
        ...
        value: function _closeNavigation() {
          ...
          fastdom.mutate(function () {
            __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].nodeListToArray(_this48.element.querySelectorAll('.is-expanded')).forEach(function (item) {
              item.classList.remove('is-expanded');
            });

            __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].nodeListToArray(_this48.element.querySelectorAll('.Header__MainNav [aria-hidden="false"]')).forEach(function (item) {
              item.setAttribute('aria-hidden', 'true');
            });
          });
        ...
        value: function _verifyNavigationOverlap() {
          ...
          fastdom.measure(function () {
            ...
            var mainTopMenu = _this49.element.querySelector('.Header__MainNav');
          ...
          fastdom.mutate(function () {
            if (isOverlapping) {
              _this49.element.classList.remove('Header--' + _this49.options['navigationStyle']);

              _this49.element.classList.add('Header--center');
            } else {
              _this49.element.classList.add('Header--' + _this49.options['navigationStyle']);

              _this49.element.classList.remove('Header--center');
            }

            _this49.element.classList.add('Header--initialized');
        ...
        value: function _checkTransparentHeader() {
          ...
          fastdom.measure(function () {
            _this50.lastScrollPosition = window.pageYOffset;
          });
          fastdom.mutate(function () {
            if (_this50.lastScrollPosition <= scrollThreshold) {
              _this50.element.classList.add('Header--transparent');
            } else {
              _this50.element.classList.remove('Header--transparent');
            }
          });
        }
      }]);
          ...
          if (!this.instafeed.hasAttribute('data-access-token')) {
            ...
            var instafeed = new Instafeed({
              ...
              after: function after() {
                ...
                _this51.carousel = new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](_this51.instafeed);
              }
            });
            instafeed.run();
          }
      ...
      _createClass(MapSection, [{
        ...
        value: function _loadScript() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            script.onerror = reject;
            script.async = true;
            script.src = 'https://maps.googleapis.com/maps/api/js?key=' + _this52.options['apiKey'];
          });
        }
      }, {
        key: '_initMap',
        value: function _initMap() {
          ...
          geocoder.geocode({
            ...
            if (status !== google.maps.GeocoderStatus.OK) {
              ...
              var map = new google.maps.Map(_this53.element.querySelector('.FeaturedMap__GMap'), mapOptions),
                  center = map.getCenter();
              map.setCenter(center);
              var icon = {
                path: "M32.7374478,5.617 C29.1154478,1.995 24.2994478,0 19.1774478,0 C14.0544478,0 9.23944778,1.995 5.61744778,5.617 C-1.08555222,12.319 -1.91855222,24.929 3.81344778,32.569 L19.1774478,54.757 L34.5184478,32.6 C40.2734478,24.929 39.4404478,12.319 32.7374478,5.617 Z M19.3544478,26 C15.4954478,26 12.3544478,22.859 12.3544478,19 C12.3544478,15.141 15.4954478,12 19.3544478,12 C23.2134478,12 26.3544478,15.141 26.3544478,19 C26.3544478,22.859 23.2134478,26 19.3544478,26 Z",
                fillColor: _this53.options['markerColor'],
                fillOpacity: 1,
              ...
              var styledMapType = new google.maps.StyledMapType(JSON.parse(_this53.element.querySelector('[data-gmap-style]').innerHTML));
        ...
        value: function _loadRecommendations() {
          ...
          return fetch(url).then(function (response) {
            return response.text().then(function (content) {
              ...
              _this54.element.querySelector('.ProductRecommendations').innerHTML = container.querySelector('.ProductRecommendations').innerHTML;
            });
          });
        }
      }, {
    ...
    var ProductSection = function () {
      ...
      _createClass(ProductSection, [{
        ...
        value: function _checkQuickNav() {
          ...
          fastdom.measure(function () {
            showAsideQuickNav = window.scrollY >= _this55.productAsideElement.offsetTop - _this55.productAsideElement.clientHeight;
          });
          fastdom.mutate(function () {
            if (showAsideQuickNav) {
              _this55.quickNav.classList.add('is-flipped');
            } else {
              _this55.quickNav.classList.remove('is-flipped');
            }
          });
        }
        /**
        ...
        value: function _setupDeviceFeatures(event) {
          ...
          if (currentBreakpoint === 'phone' || currentBreakpoint === 'tablet') {
            ...
            var calculateMinHeight = function calculateMinHeight() {
              if (_this56.productAsideElement) {
                _this56.productAsideElement.style.minHeight = _this56.productInfoElement.scrollHeight - productInfoPadding - productGalleryHeight + 'px';
                _this56.productInfoElement.closest('.Product__InfoWrapper').style.maxHeight = _this56.productAsideElement.offsetTop + _this56.productInfoElement.scrollHeight - productInfoPadding + 'px';
              } else {
                _this56.productWrapperElement.style.minHeight = _this56.productInfoElement.scrollHeight - parseInt(productInfoStyles.paddingTop) + 'px';
              }
            };
        ...
        value: function _fetchProducts() {
          ...
          fetch(window.theme.localeRootUrl + '/search?view=recently-viewed-products&type=product&q=' + queryString, {
            ...
            response.text().then(function (content) {
              ...
              _this57.element.innerHTML = tempElement.querySelector('.Section').innerHTML; // Show the section

              _this57.element.parentNode.style.display = 'block'; // Convert any amount (if applicable)

              if (window.theme.currencyConversionEnabled) {
                __WEBPACK_IMPORTED_MODULE_2__helper_Currency__["default"].convertAll(_this57.element);
              } // And finally let's create the carousel !


              _this57.carousel = new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](_this57.element.querySelector('[data-flickity-config]'));
            });
          });
        }
      }, {
        ...
        value: function _setupAnimation() {
          ...
          if (window.theme.showElementStaggering) {
            ...
            __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.ProductList .ProductItem, .ArticleList .ArticleItem')).forEach(function (item) {
              _this58.intersectionObserver.observe(item);
            });
          }
        }
      }, {
        ...
        value: function _reveal(results) {
          ...
          results.forEach(function (result) {
            if (result.isIntersecting || result.intersectionRatio > 0) {
              ...
              _this59.intersectionObserver.unobserve(result.target);
            }
          });
      ...
      _createClass(SectionContainer, [{
        ...
        value: function register(type, constructor) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__helper_Dom__["default"].nodeListToArray(document.querySelectorAll('[data-section-type=' + type + ']')).forEach(function (container) {
            _this60._createInstance(container, constructor);
          });
        }
        /**
      ...
      _createClass(ShopTheLookSection, [{
        ...
        value: function _createPocketPopovers() {
          ...
          __WEBPACK_IMPORTED_MODULE_2__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.Popover')).forEach(function (popover) {
            _this61.popovers.push(new __WEBPACK_IMPORTED_MODULE_1__components_Popover__["default"](popover, {
              activator: _this61.pocketActivatorButton,
              showOverlay: false,
              onOpen: _this61._openPocketZoom.bind(_this61),
              onClose: _this61._closePocketZoom.bind(_this61)
            }));
          });
        }
        /**
        ...
        value: function _createOuterCarousel() {
          ...
          __WEBPACK_IMPORTED_MODULE_2__helper_Dom__["default"].nodeListToArray(this.element.querySelectorAll('.ShopTheLook__ProductList')).forEach(function (item) {
            ...
            _this62.innerCarousels[lookIndex].push(new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](item, {
              onSelect: _this62._onProductChanged.bind(_this62)
        ...
        value: function _openPocketZoom(popover) {
          ...
          fastdom.mutate(function () {
            ...
            _this63.outerCarousel.flickityInstance.unbindDrag(); // Prevent changing the active slide


            _this63.outerCarousel.flickityInstance.element.classList.add('is-zoomed');

            _this63.outerCarousel.getSelectedCell().classList.add('is-expanded');
          });
        }
        /**
        ...
        value: function _calculateImageTransform(openPopover) {
          ...
          fastdom.measure(function () {
            ...
            _this64._calculateTransformForDotListener = function (event) {
              ...
              fastdom.mutate(function () {
                _this64.outerCarousel.flickityInstance.viewport.style.transform = 'translate3d(0, ' + Math.round(translateY) + 'px, 0) scale(' + scale + ')';
              });
            }; // We manually generate an event the first time to trigger the positioning


            selectedCell.addEventListener('product:changed', _this64._calculateTransformForDotListener);
        ...
        value: function _closePocketZoom() {
          ...
          fastdom.mutate(function () {
            ...
            _this65.outerCarousel.flickityInstance.bindDrag();

            _this65.outerCarousel.flickityInstance.element.classList.remove('is-zoomed');

            _this65.outerCarousel.flickityInstance.viewport.style.transform = null;
    ...
    var SlideshowSection = function () {
      ...
      _createClass(SlideshowSection, [{
        ...
        value: function _transitionToSlide(slide) {
          ...
          __WEBPACK_IMPORTED_MODULE_1__helper_Dom__["default"].nodeListToArray(slide.querySelectorAll('.Slideshow__Image')).forEach(function (image) {
            if (image.classList.contains('Image--lazyLoading') || image.classList.contains('Image--lazyLoad')) {
              image.addEventListener('lazyloaded', _this66._slideEnter.bind(_this66, slide));
            } else {
              _this66._slideEnter(slide);
            }
          });
        ...
        value: function _slideLeave(slide) {
          var content = slide.querySelector('.Slideshow__Content'),
              buttonWrapper = slide.querySelector('.Slideshow__ButtonWrapper');
        ...
        value: function _slideEnter(slide) {
          var images = slide.querySelectorAll('.Slideshow__Image'),
              content = slide.querySelector('.Slideshow__Content'),
              buttonWrapper = slide.querySelector('.Slideshow__ButtonWrapper');
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_17__ProductRecommendationsSection__ = __webpack_require__(43);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_18__ProductSection__ = __webpack_require__(44);
    /* harmony reexport (binding) */
    ...
    var __WEBPACK_IMPORTED_MODULE_19__RecentlyViewedProductsSection__ = __webpack_require__(45);
    /* harmony reexport (binding) */
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_0__components__ = __webpack_require__(19);
    /* harmony import */
    ...
    (function () {
      ...
      sections.register('product-recommendations', __WEBPACK_IMPORTED_MODULE_2__sections__["ProductRecommendationsSection"]); // Sections used on collection page
